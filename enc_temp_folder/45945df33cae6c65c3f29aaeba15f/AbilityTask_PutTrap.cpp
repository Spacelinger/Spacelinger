...
UAbilityTask_PutTrap* UAbilityTask_PutTrap::PutTrapChannelingTask(UGameplayAbility* OwningAbility, FGameplayTag ChannelingTag, float Time, /*AActor* OptionalExternalTarget,*/ bool OnlyTriggerOnce)
{
...
void UAbilityTask_PutTrap::UpdateProgressBar()
{
	if (DoorToBlock)	// remove
