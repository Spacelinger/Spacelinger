...
class SPACELINGER_API UAbilityTask_PutTrap : public UAbilityTask
{
	...
	static UAbilityTask_PutTrap* PutTrapChannelingTask(UGameplayAbility* OwningAbility, FGameplayTag ChannelingTag, float Time, /*AActor* OptionalExternalTarget = nullptr,*/ bool OnlyTriggerOnce = false);
