...
#include "MCV_AsyncTaskGameplayTagAddedRemoved.generated.h"
...
class MCVGASFRAMEWORK_API UMCV_AsyncTaskGameplayTagAddedRemoved : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UMCV_AsyncTaskGameplayTagAddedRemoved* ListenForGameplayTagAddedOrRemoved(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer Tags);
